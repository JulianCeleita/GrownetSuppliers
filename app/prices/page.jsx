                ...
                sortedPrices.map((price) => (
                  ...
                  >
                    ...
                    {/* <td className="py-4"
                                    ...
                                    >{price.price}</td> */}
                    <td
                      className={`py-4 ${getBandColorClass(price.bands_id)}`}
                      onClick={(e) => {
                        e.preventDefault();
                        enviarData(price, 1);
                      }}
                    >
                      <div className="border-b-black bg-white">
                        {calculateBandValue(price.cost, 10)}
                      </div>
                    </td>
                    <td
                      className={`py-4`}
                    ...
                    >
                      <div className="border-b-black bg-white">
                        {calculateBandValue(price.cost, 20)}
                      </div>
                    </td>
                    <td
                      onClick={(e) => {
                    ...
                    >
                      <div className="border-b-black bg-white">
                        {calculateBandValue(price.cost, 30)}
                      </div>
                    </td>
                    <td
                      onClick={(e) => {
                    ...
                    >
                      <div className="border-b-black bg-white">
                        {calculateBandValue(price.cost, 40)}
                      </div>
                    </td>
                    <td
                      onClick={(e) => {
                    ...
                    >
                      <div className="border-b-black bg-white">
                        {calculateBandValue(price.cost, 50)}
                      </div>
                    </td>
                    <td
                      onClick={(e) => {
                    ...
                    >
                      {calculateUtilityValue(price.cost, price.utility)}$
                    </td>
                    <td>
                      <button
                        onClick={() => {
