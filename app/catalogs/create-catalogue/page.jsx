  ...
  useEffect(() => {
    ...
    const fetchDataBySupplier = async () => {
      try {
        ...
        console.log(
          "🚀 ~ fetchDataBySupplier ~ customerSupplier:",
          responseRestaurants
        );
    ...
    const fetchBands = async () => {
      try {
        ...
        const sortedBands = responseBands.data.bands.sort((a, b) =>
  ...
  return (
    <Layout>
      ...
      <div className="flex flex-col items-center justify-center">
        <form
          className="text-left mt-10 w-[70%] mb-20 mx-auto"
          onSubmit={enviarData}
        >
            ...
            <div className="flex items-center mb-4">
              ...
              <Select
                ...
                value={{
                  value: presentation,
                  label: presentation
                    ? `${presentation.product_name} - ${presentation.name}`
                    : "Search...",
                }}
                isSearchable
              />
